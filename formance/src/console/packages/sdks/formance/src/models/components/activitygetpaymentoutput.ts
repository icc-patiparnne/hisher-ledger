...
import {
    FlowsPayment,
    FlowsPayment$inboundSchema,
    FlowsPayment$Outbound,
    FlowsPayment$outboundSchema,
} from "./flowspayment.js";
...
export const ActivityGetPaymentOutput$inboundSchema: z.ZodType<
    ...
    unknown
> = z.object({
    data: FlowsPayment$inboundSchema,
});

/** @internal */
export type ActivityGetPaymentOutput$Outbound = {
    data: FlowsPayment$Outbound;
};
...
export const ActivityGetPaymentOutput$outboundSchema: z.ZodType<
    ...
    ActivityGetPaymentOutput
> = z.object({
    data: FlowsPayment$outboundSchema,
});
