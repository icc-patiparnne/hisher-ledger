...
/** @internal */
export const V3AccountTypeEnum$inboundSchema: z.ZodNativeEnum<typeof V3AccountTypeEnum> =
    z.nativeEnum(V3AccountTypeEnum);

/** @internal */
export const V3AccountTypeEnum$outboundSchema: z.ZodNativeEnum<typeof V3AccountTypeEnum> =
