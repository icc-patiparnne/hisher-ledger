...
export type AddAccountToPoolRequest = {
     ...
     */
    poolId: string;
    addAccountToPoolRequest: components.AddAccountToPoolRequest;
};
...
> = z
    .object({
        poolId: z.string(),
        AddAccountToPoolRequest: components.AddAccountToPoolRequest$inboundSchema,
    })
    .transform((v) => {
        return remap$(v, {
...
export type AddAccountToPoolRequest$Outbound = {
    poolId: string;
    AddAccountToPoolRequest: components.AddAccountToPoolRequest$Outbound;
};
...
> = z
    .object({
        poolId: z.string(),
        addAccountToPoolRequest: components.AddAccountToPoolRequest$outboundSchema,
    })
    .transform((v) => {
        return remap$(v, {
            addAccountToPoolRequest: "AddAccountToPoolRequest",
