...
export namespace V3RetryPaymentInitiationResponseData$ {
    ...
    export const inboundSchema = V3RetryPaymentInitiationResponseData$inboundSchema;
    /** @deprecated use `V3RetryPaymentInitiationResponseData$outboundSchema` instead. */
    export const outboundSchema = V3RetryPaymentInitiationResponseData$outboundSchema;
